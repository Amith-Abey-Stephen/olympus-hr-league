      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <div className="relative mb-8 flex justify-center">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -top-4 -left-4 text-primary opacity-40"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -right-4 text-[#FF6B6B] opacity-40"
              >
          ...
          <p className="text-lg md:text-xl text-foreground/60 max-w-2xl mx-auto font-medium">
            Partner with Olympus to connect with the next generation of HR
            leaders and position your brand at the heart of the HR ecosystem.
          </p>
