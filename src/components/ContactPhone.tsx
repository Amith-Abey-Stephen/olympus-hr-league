        ...
        <div className="relative w-full max-w-[600px] aspect-4/3 mx-auto z-10 overflow-visible">
            ...
            >
                ...
                <g>
                    {/* The main body */}
                    <path
                        d="M 40,260 L 70,180 L 150,180 L 180,260 Z"
                        fill="black"
                    />
                    {/* Handset cradle hooks */}
                    <path d="M 70,180 L 60,165 M 150,180 L 160,165" stroke="black" strokeWidth="12" />
                    ...
                    <g fill="#333">
                        {[0, 1, 2].map(row =>
                            [0, 1, 2].map(col => (
                                <circle key={`${row}-${col}`} cx={90 + col * 20} cy={214 + row * 9} r="2.5" />
                            ))
                        )}
                    </g>
                </g>
