                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                            ...
                            />
                            {errors.firstName && <p className="text-red-600 text-xs font-bold">{errors.firstName.message}</p>}
                        </div>
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent border-b-2 border-black/10 focus:border-black py-2 outline-none placeholder:text-black/30 font-bold transition-colors"
                            />
                            {errors.lastName && <p className="text-red-600 text-xs font-bold">{errors.lastName.message}</p>}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent border-b-2 border-black/10 focus:border-black py-2 outline-none placeholder:text-black/30 font-bold transition-colors"
                            />
                            {errors.phone && <p className="text-red-600 text-xs font-bold">{errors.phone.message}</p>}
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full bg-transparent border-b-2 border-black/10 focus:border-black py-2 outline-none placeholder:text-black/30 font-bold transition-colors"
                        />
                        {errors.collegeOrOrg && <p className="text-red-600 text-xs font-bold">{errors.collegeOrOrg.message}</p>}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        {errors.interest && <p className="text-red-600 text-xs font-bold">{errors.interest.message}</p>}
                    </div>
