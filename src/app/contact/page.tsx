...
const socialLinks = [
  {
    ...
    href: "https://www.instagram.com/olympus.mulearn?igsh=Mnk1NTdxaGJ4bmVk",
  },
];
                ...
                <div className="space-y-12 mt-12">
                  <div className="group">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <a
                        href="https://www.linkedin.com/in/prapanch-j-86bb46334"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 mt-2 text-primary font-bold hover:underline"
                      >
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-3">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label="WhatsApp Diya"
                          className="inline-flex items-center gap-2 text-sm text-foreground/60 hover:text-primary transition-colors"
                        >
                          <span className="sr-only">WhatsApp Diya</span>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            x="0px"
                            y="0px"
                      ...
                      <a
                        href="https://www.linkedin.com/in/diyabenny"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 mt-2 text-primary font-bold hover:underline"
                      >
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-3">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label="WhatsApp Nandana"
                          className="inline-flex items-center gap-2 text-sm text-foreground/60 hover:text-primary transition-colors"
                        >
                          <span className="sr-only">WhatsApp Nandana</span>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            x="0px"
                            y="0px"
                      ...
                      <a
                        href="https://www.linkedin.com/in/nandana-vipin"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 mt-2 text-primary font-bold hover:underline"
                      >
              ...
              <div className="pt-8 flex gap-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-10 h-10 rounded-full border border-border flex items-center justify-center hover:bg-primary hover:border-primary hover:text-black transition-all"
                  >
                    {social.icon}
                  </a>
                ))}
